...
const Sidebar = ({ handleDrawerClose, open }: Props) => {
    ...
    const getMenuItemClassName = (path: string) => {
        if (selected === path) {
            return `${styles.menuItem} ${styles.selected}`;
        }
        ...
        <div ref={sidebarRef} className={`${styles.sidebar} ${open ? styles.sidebarOpen : ''}`}>
            ...
            <List component="nav" className={styles.menu}>
                <Link href="/admin/articles">
                    <ListItem button className={getMenuItemClassName('/admin/articles')} component="a">
                        <ListItemIcon>
                ...
                <Link href="/admin/categories">
                    <ListItem button className={getMenuItemClassName('/admin/categories')} component="a">
                        <ListItemIcon>
                ...
                <Link href="/admin/users">
                    <ListItem button className={getMenuItemClassName('/admin/users')} component="a">
                        <ListItemIcon>
                ...
                <Link href="/admin/comments">
                    <ListItem button className={getMenuItemClassName('/admin/comments')} component="a">
                        <ListItemIcon>
